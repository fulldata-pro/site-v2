...
class ApiService {
  ...
  async searchCompany(cuit: string) {
    return this.request<SearchResponse>("/api/search/companies", {
      method: "POST",
  ...
  async searchPhone(phoneNumber: string) {
    return this.request<SearchResponse>("/api/search/phones", {
      method: "POST",
  ...
  async searchBank(cbu?: string, alias?: string) {
    ...
    return this.request<SearchResponse>("/api/search/banks", {
      method: "POST",
