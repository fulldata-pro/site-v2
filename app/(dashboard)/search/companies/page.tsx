...
export default function CompanySearchPage() {
  ...
  const searches: CompanySearchRecord[] = [
    {
      id: 823,
      name: 'TECNOLOGIA GLOBAL SA',
      document: '30-71234567-9',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
      date: '06/09/2025, 5:00 p.m.',
      credits: 3,
      label: 'Due Diligence'
    },
    {
      id: 812,
      name: 'COMERCIAL DEL NORTE SRL',
      document: '30-98765432-1',
      documentType: 'CUIT',
      status: RequestStatus.PROCESSING,
      date: '05/09/2025, 3:30 p.m.',
      credits: 3,
    },
    {
      id: 801,
      name: 'INDUSTRIAS METALURGICAS SA',
      document: '30-55566677-8',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
    ...
    {
      id: 790,
      name: 'CONSULTORA EMPRESARIAL SAS',
      document: '30-44433322-1',
      documentType: 'CUIT',
      status: RequestStatus.ERROR,
      date: '03/09/2025, 2:15 p.m.',
      credits: 3,
    },
    {
      id: 779,
      name: 'DISTRIBUIDORA REGIONAL SA',
      document: '30-88899900-2',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
      date: '02/09/2025, 9:30 a.m.',
      credits: 3,
    },
    {
      id: 768,
      name: 'SERVICIOS INTEGRALES SRL',
      document: '30-11122233-4',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
      date: '01/09/2025, 4:00 p.m.',
      credits: 3,
      label: 'Priority'
    },
    {
      id: 757,
      name: 'AGROPECUARIA DEL SUR SA',
      document: '30-66677788-9',
      documentType: 'CUIT',
      status: RequestStatus.PROCESSING,
      date: '31/08/2025, 1:20 p.m.',
      credits: 3,
    },
    {
      id: 746,
      name: 'CONSTRUCTORA MODERNA SAS',
      document: '30-99988877-6',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
      date: '30/08/2025, 10:00 a.m.',
      credits: 3,
    },
    {
      id: 735,
      name: 'TRANSPORTE Y LOGISTICA SA',
      document: '30-22233344-5',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
      date: '29/08/2025, 3:45 p.m.',
      credits: 3,
      label: 'VIP'
    },
    {
      id: 724,
      name: 'FARMACEUTICA NACIONAL SRL',
      document: '30-55544433-2',
      documentType: 'CUIT',
      status: RequestStatus.ERROR,
      date: '28/08/2025, 11:30 a.m.',
      credits: 3,
    },
    {
      id: 713,
      name: 'ALIMENTOS PROCESADOS SA',
      document: '30-77766655-4',
      documentType: 'CUIT',
      status: RequestStatus.SUCCESS,
      date: '27/08/2025, 2:00 p.m.',
      credits: 3,
    },
    {
      id: 702,
      name: 'TEXTIL ARGENTINA SAS',
      document: '30-33322211-1',
      documentType: 'CUIT',
      status: RequestStatus.PROCESSING,
      date: '26/08/2025, 9:15 a.m.',
      credits: 3,
      label: 'Audit'
    }
  ]
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-services-companies rounded-xl flex items-center justify-center">
                  <ServiceIcon service={ServicesType.COMPANIES} className="text-2xl" />
                </div>
                <div>
        ...
        <div className="flex-1 overflow-hidden bg-gradient-to-br from-white to-slate-50/20">
          <div className="h-full p-8 flex flex-col">
            <DataTable
              ...
              emptyState={{
                icon: <ServiceIcon service={ServicesType.COMPANIES} className="text-4xl text-slate-400 mx-auto" />,
