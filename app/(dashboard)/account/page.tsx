                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-0 bg-white/80 rounded-xl shadow-sm ring-1 ring-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all placeholder:text-gray-400 ${errors.firstName ? 'ring-red-300 focus:ring-red-500' : ''
                        }`}
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-0 bg-white/80 rounded-xl shadow-sm ring-1 ring-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all placeholder:text-gray-400 ${errors.lastName ? 'ring-red-300 focus:ring-red-500' : ''
                        }`}
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-0 bg-white/80 rounded-xl shadow-sm ring-1 ring-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all placeholder:text-gray-400 ${errors.phone ? 'ring-red-300 focus:ring-red-500' : ''
                        }`}
                ...
                <form onSubmit={handlePasswordReset} className="space-y-6 max-w-lg">
                  {!user?.isGoogleUser && (
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border-0 bg-white/80 rounded-xl shadow-sm ring-1 ring-gray-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:bg-white transition-all ${errors.currentPassword ? 'ring-red-300 focus:ring-red-500' : ''
                          }`}
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      required
                      minLength={6}
                      className={`w-full px-4 py-3 border-0 bg-white/80 rounded-xl shadow-sm ring-1 ring-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:bg-white transition-all ${errors.newPassword ? 'ring-red-300 focus:ring-red-500' : ''
                        }`}
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-4 py-3 border-0 bg-white/80 rounded-xl shadow-sm ring-1 ring-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all ${errors.confirmPassword ? 'ring-red-300 focus:ring-red-500' : ''
                        }`}
